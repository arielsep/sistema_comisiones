...
CREATE TABLE IF NOT EXISTS `sistema_comision`.`usuarios` (
  ...
  INDEX `fk_usuarios_perfil_usuarios1_idx` (`perfil_usuarios_Id` ASC),
...
CREATE TABLE IF NOT EXISTS `sistema_comision`.`inmuebles` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_inmuebles_tipo_inmuebles1_idx` (`tipo_inmuebles_id` ASC),
  INDEX `fk_inmuebles_direccion1_idx` (`direccion_id` ASC),
  INDEX `fk_inmuebles_moneda1_idx` (`moneda_id` ASC),
...
CREATE TABLE IF NOT EXISTS `sistema_comision`.`ventas` (
  ...
  INDEX `fk_ventas_inmuebles1_idx` (`id` ASC),
  INDEX `fk_ventas_moneda1_idx` (`moneda_id` ASC),
  INDEX `fk_ventas_persona1_idx` (`persona_id` ASC),
  PRIMARY KEY (`id`),
